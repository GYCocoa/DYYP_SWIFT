...
protocol CommunityPageViewDelegate : class {
    func pageView(_ pageView : CommunityPageView, targetIndex : Int)
}

class CommunityPageView: UIView {
    
    weak var communityPageViewDelegate: CommunityPageViewDelegate?
    ...
    var childVcs: [GYCommunityOtherController]? {
        didSet {
    ...
    fileprivate lazy var titleView: CommunityTitleView = {
        let titleView = CommunityTitleView()
    ...
    fileprivate lazy var collectionView : UICollectionView = {
        ...
        layout.itemSize = CGSize(width: kWidth, height: kHeight - kNavBarHeight - 40)
...
extension CommunityPageView {
    ...
    fileprivate func setupUI() {
        ...
        communityPageViewDelegate = titleView
    }
}

extension CommunityPageView : UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension CommunityPageView : UIScrollViewDelegate {
    ...
    private func contentEndScroll() {
        ...
        // 通知titleView进行调整
        communityPageViewDelegate?.pageView(self, targetIndex: currentIndex)
    }
...
extension CommunityPageView : CommunityTitleViewDelegate {
